...
function PANEL:Init()
	...
	self:MakePopup()
	self:SetTitle("Npc Spawn Manager")
...
function PANEL:Populate(items)
	...
	for index, item in ipairs(items) do
		...
		self.index.category:SetText("NPC: "..item.npc)
...
vgui.Register("ixNPCSpawnerManager", PANEL, "DFrame")
